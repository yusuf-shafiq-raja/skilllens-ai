...
class CompetencyScore(Base):
    ...
    owner = relationship("User", back_populates="competency_scores")

    competency = relationship("Competency", back_populates="competency_scores")

    assessment_attempt = relationship(
        "AssessmentAttempt", back_populates="competency_scores"
    )
