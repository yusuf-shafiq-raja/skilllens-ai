...
from app.schemas.placement_readiness import (
...
def generate_readiness(
    ...
    return generate_placement_readiness(
        db,
        current_user,
        resume_score
    )
...
def get_readiness(
    ...
    try:
        ...
        return get_placement_readiness(
            db,
            current_user
        )
